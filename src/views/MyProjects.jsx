              ...
              <div className="mt-6 pt-4 border-t-2 border-black/10">
                ...
                {project.github && (
                  <a 
                    ...
                    className="inline-flex items-center gap-2 bg-black hover:bg-gray-800 px-4 py-2 rounded-lg mt-2 border-2 border-black"
                  >
                    ...
                    <span className="font-semibold text-white font-['Lexend_Deca']">View on GitHub</span>
                  </a>
